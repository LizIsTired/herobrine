...
public class RayTracing implements ClientModInitializer {
    @Override
    public void onInitializeClient() {
        //HudRenderCallback.EVENT.register(RayTracing::displayBoundingBox);
    }
    ...
    private static void displayBoundingBox(MatrixStack matrixStack, float tickDelta) {
        ...
        verticalRotationAxis.cross(Vector3fc.POSITIVE_Y);
        ...
        verticalRotationAxis = new Vector3f((Vector3fc) cameraDirection);
