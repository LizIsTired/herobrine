...
public class HerobrineEntityModel extends EntityModel<Herobrine> {
    ...
    @Override
    public void setAngles(Herobrine entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
    }
